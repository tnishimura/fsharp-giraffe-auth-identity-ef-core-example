// This file is a consolidated version of Giraffe.Antiforgery from
// https://github.com/pimbrouwers/Giraffe.Antiforgery, and is Copyright Pim Brouwers, licensed
// under Apache 2.0, which is included at the end of this file.
//
// I include it here because at the time of writing the blog post carpenoctem.dev/blog/fsharp-giraffe-auth-identity/ the
// package was out of date. It has slight modifications to comments.
...
// This function calls `GetAndStoreTokens` to generate a anti-csrf token, create a cookie and store it in ctx.
// However, you probably won't use it too often -- favor csrfHtmlView instead
...
// in order to use it, modify our view functions with an additional `token` parameter (it should be the last parameter)
// and then call csrfHtmlView instead of htmlView
